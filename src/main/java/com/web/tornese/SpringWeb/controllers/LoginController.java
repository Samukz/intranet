...
public class LoginController {
  ...
  public String logar(Model model, Administrador admParam, String lembrar, HttpServletResponse response)
    ...
    if (adm != null) {
      // Supondo que Administrador tenha um campo tipoUsuario
      String tipoUsuario = adm.getTipoUsuario();
      ...
      CookieService.setCookie(response, "tipoUsuario", tipoUsuario, tempoLogado); // Armazenando o tipo de usuário em um
                                                                                  // cookie
